...
public class BackgroundRack extends javax.swing.JPanel {
    ...
    public void updateView() {
        ...
        // End of Constraints
        panel = df.panelBottom(rackNum + 1);
...
//addPanel(newPanel, gridx, gridy, gridwidth, gridheight, weightx, weighty, fill, padx, pady
    ...
    public JPanel panelCondenserStats() {
        ...
        //     
        //==================================================================
        String ttp = "Refrigerant Level " + rack.getName();
    ...
    public JPanel panelCompressor() {
        ...
        c.weighty = 0;
        c.ipady = 10;
        label = new JLabel("Design | SpStPt | Psig ");
        label.setHorizontalAlignment(JLabel.CENTER);
        label.setFont(font.deriveFont(Font.BOLD, 16));
        label.setOpaque(true);
        label.setBorder(border);
        ...
        String[] tooltip = new String[]{            
            "Suction Pressure Design Setpoint " + rack.getName() + " `%sgname`",
            "Suction Pressure Setpoint " + rack.getName() + " `%sgname`",
        ...
        for (int i = 0; i < numSg; i++) {
            ...
            widgetComponents.put(tooltip[2].replace("`%sgname`", rack.getSuctionGroupNameIndex(i)), label);
            panel.add(label, c);
            c.gridx += comp[i];
        }
    ...
    public JPanel panelTop(String imgUrl, String storeName) {
        ...
        widgetComponents.put("Refrigerant Type " + rack.getName(), label);
        panel.add(label, c);

...
public class ScreenImage {
     ...
     */
    public static BufferedImage createImage(JComponent component, boolean loadTab) {
        ...
        return ScreenImage.createImage(component, region, true);
    }
     ...
     *  @return	image the image for the given region
     */
    public static BufferedImage createImage(JComponent component, Rectangle region, boolean loadTab) {
        //  Make sure the component has a size and has been layed out.
        //  (necessary check for components not added to a realized frame)
        ...
        crp.add(component);
        crp.paintComponent(image.createGraphics(), component, crp, component.getBounds());
